...
#make function to generate state lists based on the US region----
...
us_region_prep <- us_regions %>% 
  ...
  unite(state, c("State_name", "State_abbvr", "State_abbvr_TC"), sep = "(?=\\b)|")
...
#make function to identify US region from state name & abbreviations----
...
EUR <- c("Albania", "Andorra", "Armenia", "Austria", "Azerbaijan", "Belarus", "Belgium", "Bosnia and Herzegovina", "Bulgaria", "Croatia", "Cyprus", "Czech Republic", "Denmark", "Estonia", "Finland", "France", #"Georgia", 
